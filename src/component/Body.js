...
if(!offline){
    ...
    return (allRestaurants.length===0)?<Shimmer/>:(
        ...
        <div className='flex justify-center p-4  border-blue-500 bg-gray-300'><input type="Text" className='border-blue-400 p-1 mr-1 w-[50%] border-none rounded-xl pl-2' placeholder='search' value={searchText} onChange={(e)=>{
