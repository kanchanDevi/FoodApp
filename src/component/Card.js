...
const Card =({    cloudinaryImageId,
    ...
    return(
        <>     
        <div className="h-50 w-96 p-8 m-2 flex flex-col bg-white rounded justify-center">
        ...
        <p className="text-sm pb-1">{cuisines.join(', ')}</p> 
                ...
                <ul className='card-subdivision'>
                    <li className="bg-green-400 h-6 w-20 p-2 flex justify-between items-center">
